...
@implementation BusmeOverlayManager
...
- (void)viewDidLoad
{
    [super viewDidLoad];
//    
//    //map = [[BusmeMapView alloc] initWithFrame:self.view.bounds];
//	map = (struct BusmeMapView *) self.view;
//	
...
- (void) mapView:addOverlay :(MQMapView *)mapView addOverlay:(id <MQOverlay>)overlay {
...
- (void) mapView:scrollViewDidEndZooming: (MQMapView *) mapView {
	[map scrollViewDidEndZomming];
}
