...
@interface ComAdironBusmeIntegrationArguments : NSObject {
 @public
  ComAdironBusmePlatformArguments *delegate_;
}

@property (nonatomic, retain) ComAdironBusmePlatformArguments *delegate;
